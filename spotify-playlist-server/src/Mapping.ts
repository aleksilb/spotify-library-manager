...
export function mapSpotifyTrack(spotifyTrack : Spotify.Track) {
...
export function mapSpotifyAlbum(spotifyAlbum : Spotify.Album) {
    return new Album(spotifyAlbum.id, spotifyAlbum.name);
}

export function mapSpotifyArtist(spotifyArtist : Spotify.Artist) {
